...
<body>
    <div id='page'>
        ...
        <div id="container">
            <table cellpadding="" 5 cellspacing="0" width="100%">
                ...
                <tr class="destination">
                    <td colspan='8'>
                        <strong>Nama Pelapor : {{ strtoupper($master->has_reported_by->field_name ?? '' ) ?? '' }}</strong>
                    </td>
                </tr>
                <tr class="contact">
                    <td colspan='8'>
        ...
        <br>
        <strong>Dokumen ini akan diserahkan sebagai bukti pemeriksaan dengan status : {{ WorkStatus::getDescription($master->field_status) }}</strong>
        <br>
