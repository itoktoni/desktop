...
<div class="modal-header" id="modal-header">
    <h4 class="modal-title" id="modal-title">Master Product</h4>
    ...
    <div class="row">
        <div class="col-md-6">
            <div class="form-group">
                <label>Name</label>
                {!! Form::text('product_name', null, ['class' => 'form-control', 'id' => 'product_name', 'placeholder' => 'Please fill this input', 'required']) !!}
            </div>
        </div>
        ...
        <div class="col-md-6">
            <div class="form-group">
                ...
                {!! Form::text('product_description', null, ['class' => 'form-control', 'id' => 'product_description', 'placeholder' => 'Please fill this input', 'required']) !!}
            </div>
        </div>
